"""This function calculates the membrane potential and spike-times of a Leaky Integrate-and-Fire (LIF) Neuron given the following variables:
...
def leaky_IF(time_vector, v_m, c_m, r_m, e_l, i_app, v_th, v_reset, dt):
    ...
    v_calculated = v_m #vector containing the membrane potential at each point in time
    for i in range(len(time_vector) - 1):
        #The following equations describe the behavior of a LIF neuron
